...
lines_File0 = [lines1.rstrip('\n') for lines1 in open('s1.pdb_data_vl_2.5.pdb')]
lines_File1 = [lines1.rstrip('\n') for lines1 in open('s2.pdb_data_vl_2.5.pdb')]
lines_File2 = [lines1.rstrip('\n') for lines1 in open('s3.pdb_data_vl_2.5.pdb')]
lines_File3 = [lines1.rstrip('\n') for lines1 in open('s4.pdb_data_vl_2.5.pdb')]
lines_File4 = [lines1.rstrip('\n') for lines1 in open('s5.pdb_data_vl_2.5.pdb')]
