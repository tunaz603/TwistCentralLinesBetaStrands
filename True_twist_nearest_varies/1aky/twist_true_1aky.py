...
while i < length_strand_vector-1  : # pairwise calculation 
   ...
   # sys.stdout = original
    ...
    if len(cons_twist_angle) > 4:
    ...
    elif len(cons_twist_angle) == 3:
        for c in range (0,len(cons_twist_angle) - 2):
            cons_sum = 0.0
            for cc in range (c,c+2):       
                 cons_sum = cons_twist_angle[cc] + cons_sum
            cons_sum_array.append(cons_sum)
        pair_array.append((round(min(cons_sum_array)  / 2.0,3)))
        len_array.append(len(cons_twist_angle))
        #print "sum of consecutive 4 angles ", cons_sum_array
        #print "min of consecutive 4 angles ",min(cons_sum_array)
        out_char = "min of sum of consecutive 2 angles :: " + str(round(min(cons_sum_array),3)) + '\n'
        outf.write(out_char)  
        out_char = "Twist per angle :: " + str(round(min(cons_sum_array) / 2.0 ,3) ) + '\n'
        outf.write(out_char)
        
    elif len(cons_twist_angle) == 2:
       #print "smallest twist ",min(cons_twist_angle)
        ...
        outf.write(out_char)
    elif len(cons_twist_angle) == 1:
       #print "smallest twist ",min(cons_twist_angle)
        pair_array.append((round((twist_angle_return) , 3 )))
        #pair_array.append(0)
        len_array.append(len(cons_twist_angle))
        #out_char = "smallest angles :: " + str(round(min(cons_twist_angle),3)) + '\n'
        #outf.write(out_char)
...
if max_val1 != 0 and max_val2 != 0:
    ...
    out_char = "Avg MinTwist according to longest pair :: " + str(max_val1) + '\n'
    outf.write(out_char) 
elif max_val1 == 0 or max_val2 != 0:
    out_char = "Avg MinTwist according to longest pair :: " + str(max_val2) + '\n'
    outf.write(out_char) 