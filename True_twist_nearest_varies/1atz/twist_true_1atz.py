...
for i in range (0,len(atom0)-1):
    vector_length = math.sqrt(pow(float(atom0[i][6].strip()) - float(atom0[i+1][6].strip()),2) + pow(float(atom0[i][7].strip()) - float(atom0[i+1][7].strip()),2) + pow(float(atom0[i][8].strip()) - float(atom0[i+1][8].strip()),2))
